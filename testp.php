...
$q = "insert into equipo01_tests (titulo, descripcion) values ('$titulo','$descripcion')";
	$rs = ejecutar($q);
}

function crea_lista_cuestionarios() {
	...
	while($r = mysqli_fetch_array($rs)) {
		...
		$contenido .= "
            <tr>
                <td>$titulo</td> 
                <td>
 <button class='btn ver'> <a href='admin_preguntas.php?id_test=$id_test'>Agregar/Quitar</a></button>
<button class='btn eliminar' data-toggle='modal' data-target='#test$id_test'>ELIMINAR</button>
            </td>
                </tr>
        ";
	}
	...
	echo "
        <table class='existentes'>
            <tr>
                <th style='color:black';>Nombre</th> <th style='color:black';>Funciones</th> 
            </tr>
            $contenido    
        </table>
    ";
...
if(isset($_POST['eliminar'])) {
    ...
    // Se construye el query con la columna de visible en 0.
    $q = "delete from equipo01_tests where id_test = $id_test";
    ejecutar($q);
}
function crea_modal_test() {
    $q = "select * from equipo01_tests";
    $rs = ejecutar($q);
    while($r = mysqli_fetch_array($rs)) {
      $id_test = $r['id_test'];
      ...
      $descripcion = $r['descripcion']; 
      echo "
          <div id='test$id_test' class='modal fade' role='dialog'>
              <div class='modal-dialog modal-lg'>
                  <div class='modal-content'>
                  <div class='modal-body'>
                 <p><strong>¿ESTA SEGURO DE QUERER ELIMINAR...?</strong></p>
		  <p>TEST:</p>
		  <p>$titulo</p>
          <br>
          <form method='post' action='testp.php'>
        <input type='hidden' name='id_test' value='$id_test'>
        <input class='btn botone'  type='submit' name='eliminar' value='ELIMINAR'>
            </form>
...
<head>
	...
	<style>
        .enviar{background-color: #00A99D !important;color: white !important;}
...
#prevBtn , #nextBtn {
  background-color: #00AB9E  !important;
        ...
        .ver{background-color: #3d3c37 !important;color: white !important;}
...
table.existentes {
    ...
    top: 20px;}
       table > thead > tr > th:nth-child(1){width: 280px;}
        ...
        .eliminar {background: url(eliminar.png) center center no-repeat ; text-indent: -9999px;background-color:  #3d3c37 !important; display:inline;}
...
<body>
	...
	<p id="observatorio"></p>
	<div class="sidenav">
		<a href="#">INICIO</a> <a href="bak_foros.php">FOROS</a> <a href="testp.pjp" style="background-color: white;color: #2E2E2C;">TEST</a> <a href="cuestionariosbackend.php">CUESTIONARIOS</a> <a href="#">MAPAS</a> <a href="back_articulos_bueno.php">ARTÍCULOS</a>
	...
	<div class="main">
		<div id="seccion_back_foros">
			...
			<div>
				...
				<br>
<button style="background-color: white;    color: #5b5b5c;position:relative;left:20%;margin-top:10px" class="btn"  data-toggle="modal" data-target="#myModal10">CREAR NUEVO<span style="background-color:#00A99D; 
                        padding: 5.5px 20px;
                        margin-left: 10px;
                     ">+</span></button>
		</div>
...
<h4 style="color: black;width: 90%;margin-top: 10px;border-bottom:1px solid;
    margin: 0 auto;">CREAR NUEVO TEST</h4>   
<p>PASO 1. Escoger el nombre y descripcion de tu test.</p>
  <form method="post" action="testp.php" >
   
      <div class="form-group row">
        <input type="hidden" name="inserttest" value="inserttest">
         
       TITULO DEL TEST<br>   
          <div class="col-sm-10">
          <input type="text" name="titulo"></div></div>
      <br> 
      <div class="form-group row">
       Descripcion<br> <div class="col-sm-10">
        <input type="text" name="descripcion">    </div>  </div>  
        <br><input class="btn enviar" type="submit" value="PUBLICAR">
    </form>               
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
     ...
     <p><strong>¿ESTA SEGURO DE QUERER ELIMINAR...?</strong></p>
		  <p>TEST:</p>
		  <p>¿SON SOLO CELOS?</p>
		  <button class="btn botone">ELIMINAR</button>
		          <button type="button" class="btn botone" data-dismiss="modal">CANCELAR</button>
	...
	<div class="modal fade" id="exampleModalCenter02" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div   style="color:black;margin: 0 auto;" class="modal-body">
     <p><strong>¿ESTA SEGURO DE QUERER ELIMINAR...?</strong></p>
		  <p>TEST:</p>
		  <p>¿Es tu relación sana?</p>
		  <button class="btn botone">ELIMINAR</button>
		          <button type="button" class="btn botone" data-dismiss="modal">CANCELAR</button>
	...
	<div class="modal fade" id="exampleModalCenter03" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div   style="color:black;" class="modal-body">
     <p><strong>¿ESTA SEGURO DE QUERER ELIMINAR...?</strong></p>
		  <p>TEST:</p>
		  <p>¿Sabes si es violencia de género?	</p>
		  <button class="btn botone">ELIMINAR</button>
		          <button type="button" class="btn botone" data-dismiss="modal">CANCELAR</button>
	...
	<div class="modal fade" id="exampleModalCenter04" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div   style="color:black;" class="modal-body">
     <p><strong>¿ESTA SEGURO DE QUERER ELIMINAR...?</strong></p>
		  <p>TEST:</p>
		  <p>¿Sabes a quien acudir?	</p>
		  <button class="btn botone">ELIMINAR</button>
		          <button type="button" class="btn botone" data-dismiss="modal">CANCELAR</button>
	...
	<div class="modal fade" id="exampleModalCenter05" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div   style="color:black;" class="modal-body">
     <p><strong>¿ESTA SEGURO DE QUERER ELIMINAR...?</strong></p>
		  <p>TEST:</p>
		  <p>¿Puedes identificar estas situaciones de violencia de género?	</p>
		  <button class="btn botone">ELIMINAR</button>
		          <button type="button" class="btn botone" data-dismiss="modal">CANCELAR</button>
	...
	<div class="modal fade" id="exampleModalCenter06" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div   style="color:black;" class="modal-body">
     <p><strong>¿ESTA SEGURO DE QUERER ELIMINAR...?</strong></p>
	...
	<div class="modal fade" id="exampleModalCenter07" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div   style="color:black;" class="modal-body">
     <p><strong>¿ESTA SEGURO DE QUERER ELIMINAR...?</strong></p>
		  <p>TEST:</p>
		  <p>¿Control o protección?</p>
		  <button class="btn botone">ELIMINAR</button>
		          <button type="button" class="btn botone" data-dismiss="modal">CANCELAR</button>
	...
	<div class="modal fade" id="exampleModalCenter08" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div   style="color:black;" class="modal-body">
     <p><strong>¿ESTA SEGURO DE QUERER ELIMINAR...?</strong></p>
		  <p>TEST:</p>
		  <p>¿Cuánto sabes de violencia de género?	</p>
		  <button class="btn botone">ELIMINAR</button>
		          <button type="button" class="btn botone" data-dismiss="modal">CANCELAR</button>
	...
	<div class="modal fade" id="exampleModalCenter09" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div   style="color:black;" class="modal-body">
     <p><strong>¿ESTA SEGURO DE QUERER ELIMINAR...?</strong></p>
		  <p>TEST:</p>
		  <p>¿Es acaso violencia económica?	</p>
		  <button class="btn botone">ELIMINAR</button>
		          <button type="button" class="btn botone" data-dismiss="modal">CANCELAR</button>
